Shader "Custon/Tree Soft Occlusion Leaves Tipo 1"
{
    Properties {
        _Color ("Main Color", Color) = (1,1,1,1)
        _MainTex ("Main Texture", 2D) = "white" {  }
        _Cutoff ("Alpha cutoff", Range(0.25, 0.25)) = 0.25
        _BaseLight ("Base Light", Range(0.274, 0.274)) = 0.274
        _AO ("Amb. Occlusion", Range(0, 0)) = 0
        _Occlusion ("Dir Occlusion", Range(0, 0)) = 0
